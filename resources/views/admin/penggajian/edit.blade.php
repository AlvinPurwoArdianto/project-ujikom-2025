                                ...
                                @foreach ($pegawai as $pegawaiItem)
                                    @if ($pegawaiItem->is_admin == 0)
                                        <option value="{{ $pegawaiItem->id }}"
                                            {{ old('id_user', $penggajian->id_user ?? '') == $pegawaiItem->id ? 'selected' : '' }}
                        ...
                        <div class="col mb-0">
                            ...
                            <div class="col">
                                <input type="text" class="form-control" id="jabatan" name="jabatan"
                                    value="{{ $penggajian->pegawai->jabatan->nama_jabatan ?? '' }}" disabled>
                    ...
                    <div class="row mt-3">
                        <div class="col mb-0">
                            ...
                            <input type="date" class="form-control" name="tanggal_gaji"
                                value="{{ $penggajian->tanggal_gaji }}" required>
                        </div>
                        <div class="col mb-0">
                            ...
                            <div class="col">
                                <input type="number" class="form-control" name="jumlah_gaji"
                                    value="{{ $penggajian->jumlah_gaji }}" id="jumlah_gaji" required>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col mb-0">
                            ...
                            <input type="number" class="form-control" name="bonus" value="{{ $penggajian->bonus }}"
                                id="bonus" value="0">
                        </div>
                        <div class="col mb-0">
                            <label for="potongan" class="col col-form-label">Jumlah Potongan</label>
                            <div class="col">
                                <input type="number" class="form-control" value="{{ $penggajian->potongan }}"
                                    name="potongan" id="potongan" value="0" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col mb-0">
                            ...
                            <input type="number" class="form-control"
                                value="{{ $penggajian->jumlah_gaji - ($bonus ?? 0) - ($potongan ?? 0) }}"
                                name="gaji_bersih" id="gaji_bersih" readonly>
                        </div>
                    </div>
